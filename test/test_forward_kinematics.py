...
# Etiquetas
ax1.set_title("Cinemática Directa")
ax1.set_xlabel("X")
ax1.set_ylabel("Y")
ax1.set_zlabel("Z")
...
(line2,) = ax2.plot(
    puntos[:, 1], puntos[:, 2], "k-o", lw=2, markersize=8, markerfacecolor="red"
)
...
(line3,) = ax3.plot(
    puntos[:, 0], puntos[:, 2], "k-o", lw=2, markersize=8, markerfacecolor="red"
)
...
s_theta0 = Slider(
    ax=ax_theta0, label="Theta_0", valmin=-90, valmax=90, valinit=theta0, valstep=1
)
